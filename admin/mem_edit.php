  ...
  <style>
    ...
    <div class="card ">
            ...
            <div class="card-body">
              ...
              <div class="col-md-8">
                   <form action="member_db.php" method="POST" enctype="multipart/form-data"> <!-- enctype ต้องมีเมื่อต้องอัปโหลดไฟล์ -->
                    ...
                    <label for="" class="col-sm-2 col-form-label">ระดับการใช้งาน </label>
                      <div class="col-sm-10">
                        <select class="form-control select2" name="ref_l_id" id="ref_l_id" required>
                          <option value="<?php echo $row['ref_l_id'];?>"> 
                  ...
                  <div class="custom-file">
                          <input type="file" class="custom-file-input" id="mem_img" name="mem_img" accept="image/*" onchange="readURL(this);"  >
